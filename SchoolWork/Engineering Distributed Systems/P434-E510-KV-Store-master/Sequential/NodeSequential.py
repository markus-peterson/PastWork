...
# Local read algorithm for sequential consistency
...
class Node(object):
    ...
    # pid of the process that called for the set, else False.
    def process(self):
        while True:
            if len(self.queue) != 0:
                ...
                sender_pid, key, value = message[1]
                ...
                if message_seq - 1 == self.max_seq:
                    ...
                    # Check if it is the same process
                    # Unblocks when P==Q
    ...
    def set(self, key, value):
        ...
        # Blocks and waits for the P==Q part of the algorithm discussed
        # in the slides
        while self.blocking:
            print("Blocking")
            # For testing purposes, force delay.
            time.sleep(1)
            continue
